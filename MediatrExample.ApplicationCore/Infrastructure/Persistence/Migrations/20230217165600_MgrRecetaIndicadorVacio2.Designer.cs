...
namespace MediatrExample.ApplicationCore.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230217165600_MgrRecetaIndicadorVacio2")]
    partial class MgrRecetaIndicadorVacio2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MediatrExample.ApplicationCore.Domain.Receta.RecetaTipoIndicadorVacio", b =>
                {
                    ...
                    b.HasOne("MediatrExample.ApplicationCore.Domain.LineaProduccion", "TipoIndicadorVacio")
                        .WithMany()
                        .HasForeignKey("TipoIndicadorVacioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
